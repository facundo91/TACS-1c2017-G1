...
public class Actor {
    ...
    public Actor(String id) throws JSONException, IOException {
        this.setJsonResponse(tmdbService.getResource2("person", id));
        try {
    ...
    private void setImages(String id) throws JSONException, IOException {
        JSONArray imagesJson = tmdbService.getResource2("person", id + "/images").getJSONArray("profiles");
    ...
    private void setActorEnPeliculas(String id) throws JSONException, IOException {
        JSONArray creditsJson = tmdbService.getResource2("person", id + "/movie_credits").getJSONArray("cast");
